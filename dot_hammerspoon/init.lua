...
-----------------------------------------------
-- Hyper space to toggle an application
-- TODO: update "Sublime Text" to your current app (e.g. "iTerm2")
-----------------------------------------------

function toggle_application(_app)
    local app = hs.appfinder.appFromName(_app)
    if not app then
        app = hs.application.launchOrFocus(_app)
        return
    end
...
hs.hotkey.bind(hyper, 'space', function() toggle_application("Sublime Text") end)
